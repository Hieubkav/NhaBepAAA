<div>
    <nav class="bg-white shadow-lg fixed top-0 w-full z-50 transition-transform duration-300"
        x-data="{
            ...
            init() {
                window.addEventListener('scroll', () => {
                    ...
                    this.scrollAtTop = currentScrollPosition < 10;
        ...
        :class="{
            'translate-y-0': isScrollingUp || scrollAtTop,
            '-translate-y-full': !isScrollingUp && !scrollAtTop }">
